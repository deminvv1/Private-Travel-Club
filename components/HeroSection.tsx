...
export function HeroSection({
  ...
  return (
    <section className="relative h-[100vh] min-h-[600px] flex items-end">
      <Image
        src={image}
        alt={imageAlt}
        fill
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-6 pb-16 md:pb-24">
        ...
        <a
          ...
          className="inline-flex items-center gap-3 bg-white text-black px-8 py-4 text-sm font-medium tracking-widest uppercase hover:bg-white/90 transition-colors rounded-[10px]"
        >
          <WhatsAppIcon />
          {ctaLabel}
        </a>
