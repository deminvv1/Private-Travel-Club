...
const gallery = [
  { src: '/images/tild6533-3237-4136-b130-303762323166__private_jet_charter_.jpg', alt: 'Private jet charter — exclusive air travel by Private Travel Club' },
  { src: '/images/tild6439-6665-4164-b666-643462666432__b2a1d48840da35631578.jpg', alt: 'Luxury private jet interior — premium flight experience' },
  { src: '/images/Helicopter-transfer.webp', alt: 'Private jet on runway — Private Travel Club air charter' },
]
    ...
    <>
      ...
      <main>
        <section style={{ position: 'relative', width: '100%', minHeight: '100vh', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <div style={{ position: 'absolute', inset: 0, zIndex: 0, backgroundImage: "url('/images/tild6533-3237-4136-b130-303762323166__private_jet_charter_.jpg')", backgroundSize: 'cover', backgroundPosition: 'center' }} />
        ...
        <section style={{ position: 'relative', width: '100%', overflow: 'hidden' }}>
          <div style={{ position: 'absolute', inset: 0, zIndex: 0, backgroundImage: "url('/images/interior-of-a-luxury.webp')", backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed' }} />
          <div style={{ position: 'absolute', inset: 0, zIndex: 1, backgroundImage: OVERLAY }} />
        ...
        <section style={{ position: 'relative', width: '100%', overflow: 'hidden' }}>
          <div style={{ position: 'absolute', inset: 0, zIndex: 0, backgroundImage: "url('/images/tild6533-3237-4136-b130-303762323166__private_jet_charter_.jpg')", backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed' }} />
          <div style={{ position: 'absolute', inset: 0, zIndex: 1, backgroundImage: OVERLAY }} />
