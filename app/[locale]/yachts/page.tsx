...
const gallery = [
  { src: '/images/tild3330-3765-4633-a437-323863666531__f7c0a1c0ece10690ecd5.jpg', alt: 'Private yacht charter — luxury sea travel by Private Travel Club' },
  { src: '/images/Luxury-yacht.webp', alt: 'Luxury yacht on the open sea — exclusive yacht charter' },
    ...
    <>
      ...
      <main>
        ...
        <section style={{ position: 'relative', width: '100%', minHeight: '100vh', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <div style={{ position: 'absolute', inset: 0, zIndex: 0, backgroundImage: "url('/images/tild3330-3765-4633-a437-323863666531__f7c0a1c0ece10690ecd5.jpg')", backgroundSize: 'cover', backgroundPosition: 'center' }} />
        ...
        <section style={{ position: 'relative', width: '100%', overflow: 'hidden' }}>
          <div style={{ position: 'absolute', inset: 0, zIndex: 0, backgroundImage: "url('/images/tild6262-6533-4037-b434-383334356336__213934894.jpg')", backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed' }} />
        ...
        {/* ── GALLERY ── */}
        <section style={{ position: 'relative', width: '100%', overflow: 'hidden' }}>
          <div style={{ position: 'absolute', inset: 0, zIndex: 0, backgroundImage: "url('/images/tild3330-3765-4633-a437-323863666531__f7c0a1c0ece10690ecd5.jpg')", backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed' }} />
          <div className="ptc-page-bg" style={{ position: 'absolute', inset: 0, zIndex: 1, backgroundImage: OVERLAY }} />
